...
module.exports = {
    data: new SlashCommandBuilder()
        .setName("settime")
        .setDescription("Set yours or an user's voice channel time in your server.")
    ...
    async execute(interaction) {
        ...
        try {
            ...
            voiceClient.setTime(guild, User, sum);

            return interaction.reply({
                content: `Time was set to ${duration} for **${User.tag}.**`,
                ephemeral: true,
            });
